...
insert into $process (process,command_line,notepad,html_help_file_anchor,process_set_display,process_group,appaserver_yn,preprompt_help_text,post_change_javascript) values ('output_annual_comparison','output_annual_comparison \$application \$session \$process station datatype begin_month_day end_month_day year_expression aggregate_statistic output_medium',null,null,null,'output',null,null,null);
...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('output_annual_comparison','null','null','year_expression','null','4',null,null,null,null);
...
insert into $prompt (prompt,upload_filename_yn,hint_message,date_yn,input_width) values ('year_expression',null,'year_1, year_2, ... or year_1 - year_n',null,'30');
