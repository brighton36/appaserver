...
/*
#define OUTPUT_CODES_WITH_BETWEEN		"%s/%s/measurement_spreadsheet_with_codes_%s_%s_%d.csv"
#define OUTPUT_CODES_NO_BETWEEN			"%s/%s/measurement_spreadsheet_with_codes_%s_%d.csv"
#define FTP_PREPEND_CODES_WITH_BETWEEN 		"%s://%s/%s/measurement_spreadsheet_with_codes_%s_%s_%d.csv"
#define FTP_PREPEND_CODES_NO_BETWEEN 		"%s://%s/%s/measurement_spreadsheet_with_codes_%s_%d.csv"
#define FTP_NONPREPEND_CODES_WITH_BETWEEN	"/%s/measurement_spreadsheet_with_codes_%s_%s_%d.csv"
#define FTP_NONPREPEND_CODES_NO_BETWEEN		"/%s/measurement_spreadsheet_with_codes_%s_%d.csv"
#define OUTPUT_NO_CODES_WITH_BETWEEN		"%s/%s/measurement_spreadsheet_no_codes_%s_%s_%d.csv"
#define OUTPUT_NO_CODES_NO_BETWEEN		"%s/%s/measurement_spreadsheet_no_codes_%s_%d.csv"
#define FTP_PREPEND_NO_CODES_WITH_BETWEEN 	"%s://%s/%s/measurement_spreadsheet_no_codes_%s_%s_%d.csv"
#define FTP_PREPEND_NO_CODES_NO_BETWEEN 	"%s://%s/%s/measurement_spreadsheet_no_codes_%s_%d.csv"
#define FTP_NONPREPEND_NO_CODES_WITH_BETWEEN	"/%s/measurement_spreadsheet_no_codes_%s_%s_%d.csv"
#define FTP_NONPREPEND_NO_CODES_NO_BETWEEN	"/%s/measurement_spreadsheet_no_codes_%s_%d.csv"
*/
