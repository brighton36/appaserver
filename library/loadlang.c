/* invest2:$root/utility/tim/loadlang.c */
/* ------------------------------------ */
/* Tim Riley				*/
/* ------------------------------------ */
...
/* ----------------------------------
if_strcmp_is_true_continue this that;
------------------------------------- */
...
} /* if_strcmp_is_true_continue() */

/* -----------------------------------
if_strcmp_is_false_continue this that;
-------------------------------------- */
...
/* -------------------------------
Example:
send_to_exception_upon_failure yes
---------------------------------- */
...
} /* send_to_exception_upon_failure() */
