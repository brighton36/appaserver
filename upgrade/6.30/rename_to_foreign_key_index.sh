...
delete from $attribute where attribute = 'foreign_key_index';
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_prompt_yn,omit_insert_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('foreign_attribute','foreign_key_index',null,'1',null,null,null,null,null,null,null);
...
echo "alter table $table_name change primary_key_index foreign_key_index integer;" | sql.e 2>&1 | grep -v 'Unknown column'
exit 0
