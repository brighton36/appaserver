:
# src_freshwaterfish/select_wet_weight.sh
# ----------------------------------------
...
species_category="species_category in ('fish','crayfish','shrimp','mollusc','other_invertebrate','other_vertebrate')"

echo "	select $site_visit.visit_date,$site_visit.site,$site_visit.plot,throw_number,species_category,sum(weight_grams),count(*)
	...
	group by $site_visit.visit_date,$site_visit.site,$site_visit.plot,throw_number,species_category;" |
sql.e
