...
insert into $process (process,command_line,notepad,html_help_file_anchor,process_set_display,appaserver_yn,process_group,preprompt_help_text,post_change_javascript) values ('load_YSI_data','load_ysi_data \$application \$process filename station begin_date begin_time end_date end_time change_existing_data_yn n really_yn',null,null,null,null,'load',null,null);
