...
insert into $process (process,command_line,notepad,html_help_file_anchor,process_set_display,appaserver_yn,process_group,preprompt_help_text,post_change_javascript) values ('LT_upload','LT_upload \$process station filename execute_yn',null,null,null,null,'load',null,null);
insert into $role_process (role,process) values ('geo','LT_upload');
insert into $role_process (role,process) values ('supervisor','LT_upload');
insert into $role_process (role,process) values ('technican','LT_upload');
insert into $role_process (role,process) values ('technician','LT_upload');
delete from $process_parameter where process = 'LT_upload';
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('LT_upload','null','null','execute_yn','null','3',null,null,null,null);
