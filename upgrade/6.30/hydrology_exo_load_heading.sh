...
echo "alter table $table_name modify exo_load_heading char (25);" | sql.e
attribute_table=`get_table_name $application attribute`
echo "delete from $attribute_table where attribute = 'exo_load_heading';" | sql.e
echo "insert into $attribute_table					\
	...
	values('exo_load_heading','','n','text',25,0,'','','n','n');"	 |
sql.e									  
