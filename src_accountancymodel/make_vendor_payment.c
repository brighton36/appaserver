/* ---------------------------------------------------------------	*/
/* src_accountancymodel/make_vendor_payment.c				*/
/* ---------------------------------------------------------------	*/
/* 									*/
...
int main( int argc, char **argv )
{
	...
	{
		fprintf( stderr, 
"Usage: %s application process full_name street_address purchase_date_time payment_amount check_number paid_amount_due_yn\n",
		argv[ 0 ] );
		exit ( 1 );
	}
