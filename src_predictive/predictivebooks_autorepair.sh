...
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,drop_down_multi_select_yn,automatic_preselection_yn,join_1tom_each_row_yn,omit_lookup_before_drop_down_yn,ajax_fill_drop_down_yn,copy_common_attributes_yn,hint_message) values ('inventory','account','credit_account',null,null,null,null,null,null,null,'y',null,null,null);
...
insert into $folder (folder,form,insert_rows_number,subschema,lookup_before_drop_down_yn,populate_drop_down_process,post_change_process,notepad,no_initial_capital_yn,post_change_javascript,exclude_application_export_yn,html_help_file_anchor,create_view_statement,lookup_email_output_yn,appaserver_yn,data_directory,index_directory) values ('bank_upload','prompt','5','bank_upload','y',null,'post_change_bank_upload',null,null,'post_change_bank_upload( ''\$state'', \$row )',null,'bank_upload_sort_help.html',null,null,null,null,null);
...
insert into $folder (folder,form,insert_rows_number,subschema,lookup_before_drop_down_yn,populate_drop_down_process,post_change_process,notepad,no_initial_capital_yn,post_change_javascript,exclude_application_export_yn,html_help_file_anchor,create_view_statement,lookup_email_output_yn,appaserver_yn,data_directory,index_directory) values ('bank_upload_transaction','prompt','5','bank_upload','y',null,'post_change_bank_upload_transaction',null,null,null,null,null,null,null,null,null,null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,appaserver_yn,process_group,process_set_display,preprompt_help_text) values ('post_change_bank_upload_transaction','post_change_bank_upload_transaction.sh bank_date',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('bookkeeper','y',null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('supervisor','y','y');
insert into $subschemas (subschema) values ('bank_upload');
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_prompt_yn,omit_insert_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('inventory','credit_account',null,'1',null,null,null,null,null,null,null);
...
echo "create table $table_name (inventory_name char (30) not null,credit_account char (60),cost_of_goods_sold_account char (60),retail_price double (10,2),inventory_category char (30),reorder_quantity integer,quantity_on_hand integer,average_unit_cost double (12,4),total_cost_balance double (14,5)) engine MyISAM;" | sql.e
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('feeder_bank_upload','load_bank_spreadsheet \$process \$login_name fund filename 1 2 3 -1 4 execute_yn',null,null,null,null,'load',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_bank_upload_transaction','post_change_bank_upload_transaction.sh bank_date',null,null,null,null,null,null,null);
...
insert into transaction ( full_name, street_address, transaction_date_time, transaction_amount, memo ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:22:49', '$cash_opening_balance', 'Opening entry' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, debit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:22:49', '$cash_account_name', '$cash_opening_balance' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, credit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:22:49', '$equity_account_name', '$cash_opening_balance' );
insert into bank_upload ( bank_date, bank_description, sequence_number, bank_running_balance ) values ( '2019-04-18', 'Opening balance', '1', '$cash_opening_balance' );
insert into bank_upload_transaction ( bank_date, bank_description, full_name, street_address, transaction_date_time ) values ( '2019-04-18', 'Opening balance', 'changeme', '1234 Main St.', '2019-04-18 12:22:49' );
all_done13
) | sql.e 2>&1 | grep -vi duplicate

automatic_transaction_assign.sh all >/dev/null
bank_upload_sequence_propagate.sh '' >/dev/null
bank_upload_balance_propagate.sh '' >/dev/null
...
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Mobil1 Oil Filter','oil_inventory','cost_of_goods_sold','standard','16.99','20','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Plain oil','oil_inventory','cost_of_goods_sold','standard','10.00','50','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W20','oil_inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W30','oil_inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Radiator Cap','coolant_inventory','cost_of_goods_sold','standard','12.99','20','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Trinity Multi Vehicle Coolant','coolant_inventory','cost_of_goods_sold','standard','3.00','20','0','0.0000','0.00000');
all_done8
) | sql.e 2>&1 | grep -vi duplicate
