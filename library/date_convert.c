				...
				char *date_string )
{
	...
	if ( strcasecmp( date_string, "yesterday" ) == 0 )
		date_string = date_get_yesterday_yyyy_mm_dd();
	else
	if ( strcasecmp( date_string, "monday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_MONDAY );
	else
	if ( strcasecmp( date_string, "tuesday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_TUESDAY );
	else
	if ( strcasecmp( date_string, "wednesday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_WEDNESDAY );
	else
	if ( strcasecmp( date_string, "thursday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_THURSDAY );
	else
	if ( strcasecmp( date_string, "friday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_FRIDAY );
	else
	if ( strcasecmp( date_string, "saturday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_SATURDAY );
	else
	if ( strcasecmp( date_string, "sunday" ) == 0 )
		date_string = date_get_day_of_week_yyyy_mm_dd( WDAY_SUNDAY );
