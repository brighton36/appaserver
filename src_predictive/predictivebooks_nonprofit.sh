...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_bank_upload','post_change_bank_upload \$application \$state \$dictionary',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('accountant','y',null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('supervisor','y','y');
insert into $subschemas (subschema) values ('ledger');
...
echo "create table $table_name (account char (60) not null,subclassification char (35),fund char (20),hard_coded_account_key char (40)) engine MyISAM;" | sql.e '^' mysql
...
insert into account (account,fund,subclassification,hard_coded_account_key) values ('cost_of_goods_sold','general_fund','cost_of_goods_sold',null);
insert into account (account,fund,subclassification,hard_coded_account_key) values ('inventory','general_fund','inventory',null);
insert into account (account,fund,subclassification,hard_coded_account_key) values ('State Registration','general_fund','taxes',null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_bank_upload','post_change_bank_upload \$application \$state \$dictionary',null,null,null,null,null,null,null);
