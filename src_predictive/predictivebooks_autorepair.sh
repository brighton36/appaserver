...
echo "insert into transaction ( full_name, street_address, transaction_date_time, transaction_amount, memo ) values ( 'changeme', '1234 Main St.', '2019-04-16 12:59:31', '$cash_opening_balance', 'Opening entry' )"
echo "insert into journal_ledger ( full_name, street_address, transaction_date_time, account, debit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-16 12:59:31', '$cash_account_name', '$cash_opening_balance' )"
echo "insert into journal_ledger ( full_name, street_address, transaction_date_time, account, credit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-16 12:59:31', '$equity_account_name', '$cash_opening_balance' )"
...
echo "insert into bank_upload_transaction ( bank_date, bank_description, full_name, street_address, transaction_date_time ) values ( '2019-04-16', 'Opening balance', 'changeme', '1234 Main St.', '2019-04-16 12:59:31' )"
all_done13
) | sql.e 2>&1 | grep -vi duplicate
