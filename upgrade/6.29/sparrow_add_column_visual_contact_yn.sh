...
(
table_name=`get_table_name $application sparrow_observation`
echo "alter table $table_name add visual_contact_yn char (1);" | sql.e
...
echo "insert into $folder_attribute_table				\
	...
	values								\
	('sparrow_observation','visual_contact_yn',0,2,'n','n');"	 				 |
sql.e
