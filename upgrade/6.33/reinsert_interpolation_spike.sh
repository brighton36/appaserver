...
insert into $process (process,command_line,notepad,html_help_file_anchor,process_set_display,appaserver_yn,process_group,preprompt_help_text,post_change_javascript) values ('estimation_linear_interpolation_spike','estimation_linear_interpolation_spike_output \$person \$role station datatype minimum_spike \$dictionary begin_date begin_time end_date end_time trim_negative_drop_yn chart_yn notes really_yn',null,null,null,null,'manipulate',null,null);
...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('estimation_linear_interpolation_spike','null','null','chart_yn','null','10',null,null,null,null);
...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('estimation_linear_interpolation_spike','null','null','execute_yn','null','11',null,null,null,null);
...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('estimation_linear_interpolation_spike','null','null','trim_negative_drop_yn','null','9',null,null,null,null);
...
insert into $prompt (prompt,hint_message,upload_filename_yn,date_yn,input_width) values ('trim_negative_drop_yn',null,null,null,'1');
