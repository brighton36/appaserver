...
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('tax_form_category','account','null','1',null,null,null,null,'y',null,null,null,'y',null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('account','display_order',null,'3',null,null,null,null,null,null,null);
...
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('bank_upload','prompt','5',null,null,null,'post_change_bank_upload( ''\$state'', \$row )',null,'post_change_bank_upload',null,null,null,null,null,null,'ledger',null);
...
delete from $folder where folder = 'category';
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('category','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
delete from $relation where folder = 'category';
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('historical_fixed_asset_purchase','category','null',null,null,null,null,null,null,null,null,null,null,null);
delete from $attribute where attribute = 'category';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('category','text','20',null,null,null,null,null,null,null);
delete from $folder_attribute where folder = 'category';
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('category','category','1',null,null,null,null,null,null,null,null);
insert into $role_folder (folder,role,permission) values ('category','supervisor','insert');
insert into $role_folder (folder,role,permission) values ('category','supervisor','update');
delete from $javascript_folders where folder = 'category';
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('static');
insert into $role_operation (folder,role,operation) values ('category','supervisor','delete');
insert into $role_operation (folder,role,operation) values ('category','supervisor','detail');
delete from $folder where folder = 'contact';
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('contact','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'patron',null);
...
insert into $role_folder (folder,role,permission) values ('contact','librarian','insert');
insert into $role_folder (folder,role,permission) values ('contact','librarian','update');
...
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('librarian','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('patron');
insert into $role_operation (folder,role,operation) values ('contact','librarian','delete');
insert into $role_operation (folder,role,operation) values ('contact','librarian','detail');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('contra_account','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('customer','table','5',null,null,null,null,null,null,null,null,null,'n',null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('customer_payment','prompt','1',null,null,null,null,null,'post_change_customer_payment',null,null,null,null,null,null,'sale',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('customer_sale','prompt','1',null,null,null,null,null,'post_change_customer_sale',null,null,null,'y',null,null,'sale',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_customer_sale','post_change_customer_sale \$application full_name street_address sale_date_time \$state preupdate_full_name preupdate_street_address preupdate_title_passage_rule preupdate_completed_date_time preupdate_shipped_date_time preupdate_arrived_date preupdate_shipping_revenue',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('sale');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('depreciation','prompt','5',null,null,null,null,null,'null',null,null,null,null,null,null,'purchase',null);
delete from $relation where folder = 'depreciation';
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('depreciation','fixed_asset_purchase','null',null,null,null,null,null,null,null,null,null,null,null);
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('depreciation','transaction','null',null,null,null,'n',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'full_name';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('full_name','text','60',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'street_address';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('street_address','text','40',null,null,null,null,null,null,null);
...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('serial_number','reference_number','10',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'depreciation_date';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('depreciation_date','current_date','10',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'units_produced';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('units_produced','integer','6',null,null,null,null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','asset_name','4',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','depreciation_amount',null,'4','y',null,null,null,'y',null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','depreciation_date','6',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','full_name','1',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','purchase_date_time','3',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','serial_number','5',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','street_address','2',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','transaction_date_time',null,'5','y',null,null,null,'y',null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('depreciation','units_produced',null,'1',null,null,null,null,null,null,null);
insert into $role_folder (folder,role,permission) values ('depreciation','accountant','lookup');
...
delete from $process where process = 'null';
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('null',null,null,null,null,null,'y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('purchase');
insert into $role_operation (folder,role,operation) values ('depreciation','accountant','delete');
insert into $role_operation (folder,role,operation) values ('depreciation','accountant','detail');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('depreciation_method','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('donation','prompt','1',null,null,null,null,null,'post_change_donation',null,null,null,'y',null,null,'donation',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_donation','post_change_donation \$application full_name street_address donation_date \$state preupdate_full_name preupdate_street_address preupdate_donation_date',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('dataentry','n',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('donation_account','prompt','5',null,null,null,null,null,'post_change_donation_account',null,null,null,null,null,null,'donation',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_donation_account','post_change_donation_account \$application full_name street_address donation_date account \$state preupdate_account preupdate_donation_amount',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('dataentry','n',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('donation');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('element','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('entity','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'ledger',null);
...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('zip_code','text','5',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'email_address';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('email_address','text','50',null,null,null,null,null,null,null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('fixed_asset','prompt','5',null,null,null,null,null,'post_change_fixed_asset',null,null,null,null,null,null,'purchase',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_fixed_asset','post_change_fixed_asset \$application asset_name account \$state preupdate_account',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('purchase');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('fixed_asset_purchase','prompt','5',null,null,null,'post_change_fixed_asset_purchase( \$row )',null,'post_change_fixed_asset_purchase',null,null,null,'y',null,null,'purchase',null);
...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('accumulated_depreciation','float','10','2',null,null,null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','accumulated_depreciation',null,'7','y',null,null,null,'y',null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','asset_name','4',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','declining_balance_n',null,'6',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','depreciation_method',null,'2',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','disposal_date',null,'9',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','estimated_residual_value',null,'5',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','estimated_useful_life_units',null,'4',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','estimated_useful_life_years',null,'3',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','extension',null,'1',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','full_name','1',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','purchase_date_time','3',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','serial_number','5',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('fixed_asset_purchase','street_address','2',null,null,null,null,null,null,null,null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('fund','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('inventory','prompt','5','populate_inventory',null,null,null,null,null,null,null,null,null,null,null,'purchase',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('populate_inventory','populate_inventory.sh \$application \$one2m_folder',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('purchase');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('inventory_cost_method','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('inventory_purchase','prompt','5',null,null,null,null,null,'post_change_inventory_purchase',null,null,null,null,null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('inventory_sale','prompt','10',null,null,null,null,null,'post_change_inventory_sale',null,null,null,null,null,null,'sale',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_inventory_sale','post_change_inventory_sale \$application full_name street_address sale_date_time inventory_name \$state preupdate_quantity preupdate_retail_price preupdate_discount_amount preupdate_inventory_name',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('sale');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('journal_ledger','prompt','10',null,null,null,'post_change_journal_ledger( ''\$state'' )',null,'post_change_journal_ledger',null,null,null,null,null,null,'ledger',null);
...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('balance','float','10','2',null,null,null,null,null,null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('prepaid_asset','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('prepaid_asset_accrual','prompt','5',null,null,null,null,null,'post_change_prepaid_asset_accrual',null,null,null,null,null,null,'purchase',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('post_change_prepaid_asset_accrual','post_change_prepaid_asset_accrual \$application full_name street_address purchase_date_time asset_name accrual_date \$state preupdate_full_name preupdate_street_address preupdate_purchase_date_time preupdate_asset_name preupdate_accrual_date',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('purchase');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('prepaid_asset_purchase','prompt','5',null,null,null,null,null,'post_change_prepaid_asset_purchase',null,null,null,'y',null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('program','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('purchase_order','prompt','1',null,null,'Implementational restriction warning: inventory_purchase purchase orders should not be comingled with other purchase orders.',null,null,'post_change_purchase_order',null,null,null,'y',null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('reoccurring_transaction','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'ledger',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('self','table','1',null,null,null,null,null,'post_change_self',null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('service','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'sale',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('service_category','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('status','table','3',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('subclassification','prompt','5','populate_subclassification',null,null,null,null,null,null,null,null,'y',null,null,'ledger',null);
...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,process_set_display,appaserver_yn,process_group,preprompt_help_text) values ('populate_subclassification','populate_subclassification.sh \$application \$where \$state',null,null,null,null,null,null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('ledger');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('supply','table','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('tax_form','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
delete from $relation where folder = 'tax_form';
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('tax_form_category','tax_form','null',null,null,null,null,null,null,null,null,null,null,null);
...
delete from $folder where folder = 'tax_form_category';
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('tax_form_category','prompt','5',null,null,null,null,null,null,null,null,null,null,null,null,'ledger',null);
delete from $relation where folder = 'tax_form_category';
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('tax_form_category','account','null','1',null,null,null,null,'y',null,null,null,'y',null);
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('tax_form_category','tax_form','null',null,null,null,null,null,null,null,null,null,null,null);
delete from $attribute where attribute = 'tax_form';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('tax_form','text','20',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'tax_form_category';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('tax_form_category','text','35',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'account';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('account','text','60',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'tax_form_line';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('tax_form_line','text','4',null,null,null,null,null,null,null);
...
delete from $folder_attribute where folder = 'tax_form_category';
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('tax_form_category','account','3',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('tax_form_category','itemize_accounts_yn',null,'2',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('tax_form_category','tax_form','1',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('tax_form_category','tax_form_category','2',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('tax_form_category','tax_form_line',null,'1',null,null,null,null,null,null,null);
insert into $role_folder (folder,role,permission) values ('tax_form_category','accountant','insert');
insert into $role_folder (folder,role,permission) values ('tax_form_category','accountant','update');
insert into $role_folder (folder,role,permission) values ('tax_form_category','supervisor','insert');
insert into $role_folder (folder,role,permission) values ('tax_form_category','supervisor','update');
delete from $javascript_folders where folder = 'tax_form_category';
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('accountant','y',null,null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn,grace_no_cycle_colors_yn) values ('supervisor','y','y',null);
insert into $subschemas (subschema) values ('ledger');
insert into $role_operation (folder,role,operation) values ('tax_form_category','accountant','delete');
insert into $role_operation (folder,role,operation) values ('tax_form_category','accountant','detail');
insert into $role_operation (folder,role,operation) values ('tax_form_category','supervisor','delete');
insert into $role_operation (folder,role,operation) values ('tax_form_category','supervisor','detail');
delete from $folder where folder = 'title_passage_rule';
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('title_passage_rule','table','3',null,null,null,null,null,null,null,null,null,null,null,null,'static',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('transaction','prompt','1',null,null,null,null,null,null,null,null,null,'y',null,null,'ledger',null);
...
insert into $row_security_role_update (folder,attribute_not_null,supervisor_role) values ('transaction','lock_transaction_yn','supervisor');
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('vendor','prompt','5',null,null,null,null,null,null,null,null,null,'n',null,null,'purchase',null);
...
insert into $folder (folder,form,insert_rows_number,populate_drop_down_process,lookup_email_output_yn,notepad,post_change_javascript,html_help_file_anchor,post_change_process,no_initial_capital_yn,row_access_count,exclude_application_export_yn,lookup_before_drop_down_yn,appaserver_yn,data_directory,subschema,index_directory) values ('vendor_payment','prompt','1',null,null,null,null,null,'post_change_vendor_payment',null,null,null,null,null,null,'purchase',null);
...
echo "create table $table_name (account char (60) not null,subclassification char (35),fund char (20),display_order integer,hard_coded_account_key char (40)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (account);" | sql.e '^' mysql
echo "create unique index ${table_name}_additional_unique on $table_name (fund,hard_coded_account_key);" | sql.e '^' mysql
table_name=`get_table_name $application bank_upload`
echo "create table $table_name (bank_date date not null,bank_description char (140) not null,sequence_number integer,bank_amount double (10,2),bank_running_balance double (12,2),fund char (20),posted_yn char (1)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (bank_date,bank_description);" | sql.e '^' mysql
table_name=`get_table_name $application category`
echo "create table $table_name (category char (20) not null) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (category);" | sql.e '^' mysql
table_name=`get_table_name $application contact`
echo "create table $table_name (email_address char (50) not null,date date not null,time char (7) not null,subject char (30),message text) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (email_address,date,time);" | sql.e '^' mysql
table_name=`get_table_name $application contra_account`
echo "create table $table_name (contra_to_account char (60) not null,account char (60)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (contra_to_account);" | sql.e '^' mysql
...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,sale_date_time datetime not null,fund char (20),title_passage_rule char (15),shipped_date_time datetime,shipping_revenue double (8,2),arrived_date date,sum_extension double (10,2),sales_tax double (7,2),invoice_amount double (10,2),total_payment double (10,2),amount_due double (10,2),completed_date_time datetime,uncollectible_writeoff_date date,transaction_date_time datetime) engine MyISAM;" | sql.e '^' mysql
...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,purchase_date_time datetime not null,asset_name char (60) not null,serial_number integer not null,depreciation_date date not null,units_produced integer,depreciation_amount double (10,2),transaction_date_time datetime) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address,purchase_date_time,asset_name,serial_number,depreciation_date);" | sql.e '^' mysql
...
table_name=`get_table_name $application donation`
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,donation_date date not null,check_number integer,total_donation_amount double (10,2),transaction_date_time datetime) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address,donation_date);" | sql.e '^' mysql
table_name=`get_table_name $application donation_account`
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,donation_date date not null,account char (60) not null,donation_amount double (10,2)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address,donation_date,account);" | sql.e '^' mysql
table_name=`get_table_name $application element`
echo "create table $table_name (element char (20) not null,accumulate_debit_yn char (1),display_order integer) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (element);" | sql.e '^' mysql
table_name=`get_table_name $application entity`
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,city char (20),state_code char (2),zip_code char (5),email_address char (50)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address);" | sql.e '^' mysql
table_name=`get_table_name $application fixed_asset`
echo "create table $table_name (asset_name char (60) not null,account char (60)) engine MyISAM;" | sql.e '^' mysql
...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,purchase_date_time datetime not null,asset_name char (60) not null,serial_number integer not null,extension double (10,2),depreciation_method char (25),estimated_useful_life_years integer,estimated_useful_life_units integer,estimated_residual_value integer,declining_balance_n integer,accumulated_depreciation double (10,2),disposal_date date) engine MyISAM;" | sql.e '^' mysql
...
table_name=`get_table_name $application fund`
echo "create table $table_name (fund char (20) not null) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (fund);" | sql.e '^' mysql
table_name=`get_table_name $application inventory`
echo "create table $table_name (inventory_name char (30) not null,inventory_account char (60),cost_of_goods_sold_account char (60),retail_price double (10,2),reorder_quantity integer,quantity_on_hand integer,average_unit_cost double (12,4),total_cost_balance double (14,5)) engine MyISAM;" | sql.e '^' mysql
...
table_name=`get_table_name $application prepaid_asset`
echo "create table $table_name (asset_name char (60) not null,asset_account char (60),expense_account char (60)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (asset_name);" | sql.e '^' mysql
table_name=`get_table_name $application prepaid_asset_accrual`
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,purchase_date_time datetime not null,accrual_date date not null,asset_name char (60) not null,accrual_amount double (8,2),transaction_date_time datetime) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address,purchase_date_time,accrual_date,asset_name);" | sql.e '^' mysql
table_name=`get_table_name $application prepaid_asset_purchase`
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,purchase_date_time datetime not null,asset_name char (60) not null,extension double (10,2),accrual_period_years double (4,2),accumulated_accrual double (8,2)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address,purchase_date_time,asset_name);" | sql.e '^' mysql
table_name=`get_table_name $application program`
echo "create table $table_name (program char (30) not null) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (program);" | sql.e '^' mysql
...
echo "create unique index ${table_name}_additional_unique on $table_name (arrived_date_time);" | sql.e '^' mysql
...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,inventory_cost_method char (15)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (full_name,street_address);" | sql.e '^' mysql
table_name=`get_table_name $application service`
echo "create table $table_name (service_name char (30) not null,retail_price double (10,2)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (service_name);" | sql.e '^' mysql
table_name=`get_table_name $application service_category`
...
table_name=`get_table_name $application status`
echo "create table $table_name (status char (10) not null,sort_order integer) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (status);" | sql.e '^' mysql
...
table_name=`get_table_name $application tax_form_category`
echo "create table $table_name (tax_form char (20) not null,tax_form_category char (35) not null,account char (60) not null,tax_form_line char (4),itemize_accounts_yn char (1)) engine MyISAM;" | sql.e '^' mysql
echo "create unique index $table_name on $table_name (tax_form,tax_form_category,account);" | sql.e '^' mysql
...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,transaction_date_time datetime not null,memo char (60),transaction_amount double (10,2),check_number integer,program char (30),lock_transaction_yn char (1)) engine MyISAM;" | sql.e '^' mysql
...
insert into subclassification (subclassification,element,display_order) values ('account_receivable','asset','2');
insert into subclassification (subclassification,element,display_order) values ('cash','asset','1');
insert into subclassification (subclassification,element,display_order) values ('concert_revenue','revenue','2');
insert into subclassification (subclassification,element,display_order) values ('cost_of_goods_sold','expense','2');
insert into subclassification (subclassification,element,display_order) values ('current_liability','liability','60');
insert into subclassification (subclassification,element,display_order) values ('depreciation','expense','9');
insert into subclassification (subclassification,element,display_order) values ('discretionary','expense','1');
insert into subclassification (subclassification,element,display_order) values ('donation','revenue','1');
insert into subclassification (subclassification,element,display_order) values ('fixed_asset','asset','4');
insert into subclassification (subclassification,element,display_order) values ('gain','gain',null);
insert into subclassification (subclassification,element,display_order) values ('goodwill','equity','10');
insert into subclassification (subclassification,element,display_order) values ('interest','revenue','5');
insert into subclassification (subclassification,element,display_order) values ('inventory','asset','9');
...
insert into subclassification (subclassification,element,display_order) values ('merchandise_sale','revenue','4');
insert into subclassification (subclassification,element,display_order) values ('net_assets','equity','30');
insert into subclassification (subclassification,element,display_order) values ('prepaid','asset','3');
insert into subclassification (subclassification,element,display_order) values ('refund_gain','gain',null);
insert into subclassification (subclassification,element,display_order) values ('taxes','expense','7');
insert into account (account,subclassification,hard_coded_account_key) values ('account_payable_general_fund','current_liability','account_payable_key');
insert into account (account,subclassification,hard_coded_account_key) values ('account_payable_music_fund','current_liability','account_payable_key');
insert into account (account,subclassification,hard_coded_account_key) values ('account_receivable','account_receivable','account_receivable_key');
...
insert into account (account,subclassification,hard_coded_account_key) values ('advertising','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('amazon_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('amazon_smile','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Association Membership Dues','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('association_dues','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('auction_item_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Audio','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Audio (Historical estimate)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('awards_and_recognitions','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('bakery_sale','concert_revenue',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Band lapel pins','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('band_boosters_collection','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('bank_fee','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('bank_of_america_checking','cash','cash_key');
insert into account (account,subclassification,hard_coded_account_key) values ('bestbuy_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('beverage_sale','concert_revenue',null);
insert into account (account,subclassification,hard_coded_account_key) values ('big_day_of_giving','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('blue_shirt_cost_of_goods_sold','cost_of_goods_sold',null);
insert into account (account,subclassification,hard_coded_account_key) values ('blue_shirt_inventory','inventory',null);
insert into account (account,subclassification,hard_coded_account_key) values ('bulk_email_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('calendar_bookmarks','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('California State Registration','taxes',null);
insert into account (account,subclassification,hard_coded_account_key) values ('concert_decorations','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Copier Lease Payment Late Fee','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Copier maintenance plan','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('copier_lease_payable','current_liability',null);
insert into account (account,subclassification,hard_coded_account_key) values ('copier_paper','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('copier_property_tax','taxes',null);
insert into account (account,subclassification,hard_coded_account_key) values ('credit_card_hardware','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('dance_team_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('depreciation_expense','discretionary','depreciation_expense_key');
insert into account (account,subclassification,hard_coded_account_key) values ('dinner_table_accessories','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Director''s pay','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Director''s payable','current_liability',null);
insert into account (account,subclassification,hard_coded_account_key) values ('dollar_jar','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('dollar_tree_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('fixed_asset_expense','discretionary','fixed_asset_expense_key');
insert into account (account,subclassification,hard_coded_account_key) values ('food, beverage, wares purchase for resale','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('food_sale','concert_revenue',null);
insert into account (account,subclassification,hard_coded_account_key) values ('free concert for rent goodwill','goodwill',null);
insert into account (account,subclassification,hard_coded_account_key) values ('freight_in_general_fund','discretionary','freight_in_key');
insert into account (account,subclassification,hard_coded_account_key) values ('freight_in_music_fund','discretionary','freight_in_key');
insert into account (account,subclassification,hard_coded_account_key) values ('gain','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('gain_on_copier_purchase','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('general fund net assets','net_assets','closing_key');
insert into account (account,subclassification,hard_coded_account_key) values ('general_fund_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('general_interfund_transfer_in','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('general_interfund_transfer_out','loss',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Insurance Expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('interest_general_fund','interest',null);
insert into account (account,subclassification,hard_coded_account_key) values ('interest_memorial_fund','interest',null);
insert into account (account,subclassification,hard_coded_account_key) values ('interest_scholarship_fund','interest',null);
insert into account (account,subclassification,hard_coded_account_key) values ('intrafund_transfer','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('inventory_loss','loss','inventory_loss_key');
insert into account (account,subclassification,hard_coded_account_key) values ('in_kind_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Liability Insurance','prepaid',null);
insert into account (account,subclassification,hard_coded_account_key) values ('library_supplies','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('mailing_envelopes','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('MARIE CALLENDE expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('member_dues','donation','dues_key');
insert into account (account,subclassification,hard_coded_account_key) values ('merchandise_cost_of_goods_sold','cost_of_goods_sold',null);
insert into account (account,subclassification,hard_coded_account_key) values ('merchandise_inventory','inventory',null);
insert into account (account,subclassification,hard_coded_account_key) values ('merchandise_sale','merchandise_sale','sales_revenue_key');
insert into account (account,subclassification,hard_coded_account_key) values ('miscellaneous_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Music Library (General)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Music library (Historical estimate)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Music Library (Memorial)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music memorial net assets','net_assets','closing_key');
insert into account (account,subclassification,hard_coded_account_key) values ('music_folder_boxes','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music_interfund_transfer_in','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music_interfund_transfer_out','loss',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music_library_accumulated_depreciation','fixed_asset','accumulated_depreciation_key');
insert into account (account,subclassification,hard_coded_account_key) values ('music_library_depreciation','depreciation','depreciation_expense_key');
insert into account (account,subclassification,hard_coded_account_key) values ('music_memorial_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music_memorial_savings_8835','cash','cash_key');
insert into account (account,subclassification,hard_coded_account_key) values ('music_return_loss','loss',null);
insert into account (account,subclassification,hard_coded_account_key) values ('music_score_folders_100_pack','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Office/Room','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Office/Room (Historical estimate)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('officemax_officedepot_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('partycity_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('paypal_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('paypal_receivable','account_receivable',null);
insert into account (account,subclassification,hard_coded_account_key) values ('pepboys_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Percussion','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Percussion (Historical estimate)','fixed_asset',null);
insert into account (account,subclassification,hard_coded_account_key) values ('performance_fee','concert_revenue','service_revenue_key');
insert into account (account,subclassification,hard_coded_account_key) values ('petty_cash','cash',null);
insert into account (account,subclassification,hard_coded_account_key) values ('postage','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Postal box rental','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('prepaid_auction_items','prepaid',null);
insert into account (account,subclassification,hard_coded_account_key) values ('promotion_items','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('quickbooks_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('race_for_the_arts','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('race_for_the_arts_receivable','account_receivable',null);
insert into account (account,subclassification,hard_coded_account_key) values ('raffle_tickets','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('raffle_ticket_sale','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('refund_in_error','refund_gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('rehearsal_snacks','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Rent','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Rent payable','current_liability',null);
insert into account (account,subclassification,hard_coded_account_key) values ('sales_tax_general_fund','taxes','sales_tax_key');
insert into account (account,subclassification,hard_coded_account_key) values ('sales_tax_music_fund','taxes','sales_tax_key');
insert into account (account,subclassification,hard_coded_account_key) values ('sam''s_club_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('scholarship net assets','net_assets','closing_key');
insert into account (account,subclassification,hard_coded_account_key) values ('scholarship_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('scholarship_interfund_transfer_in','gain',null);
insert into account (account,subclassification,hard_coded_account_key) values ('scholarship_interfund_transfer_out','loss',null);
insert into account (account,subclassification,hard_coded_account_key) values ('scholarship_savings_8838','cash','cash_key');
insert into account (account,subclassification,hard_coded_account_key) values ('slippage','loss','loss_key');
insert into account (account,subclassification,hard_coded_account_key) values ('slippage (music memorial fund)','loss',null);
insert into account (account,subclassification,hard_coded_account_key) values ('SmartNFinal_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('sponsor_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('staples_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('tax_filing_charge','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('timpani_repair_and_maintenance','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('tools','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('Truck/gas','discretionary',null);
...
insert into account (account,subclassification,hard_coded_account_key) values ('under_the_big_top_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('unidentified_purchase','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('unknown_donation','donation',null);
insert into account (account,subclassification,hard_coded_account_key) values ('venue_cleanup_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('venue_deposit','prepaid',null);
insert into account (account,subclassification,hard_coded_account_key) values ('venue_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('walmart_expense','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('water','discretionary',null);
insert into account (account,subclassification,hard_coded_account_key) values ('website_donation','donation',null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('create_application','create_application \$application build_shell_script_yn \$login_name \$role destination_application system_folders_yn output2file_yn really_yn database_management_system',null,null,null,null,null,null,'y');
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('view_documentation','view_diagrams \$application \$session \$login_name \$role',null,null,null,null,'documentation',null,'y');
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('change_password','maintain_user_account \$application \$session \$person \$role',null,null,null,null,'manipulate',null,'y');
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_donation','post_change_donation \$application full_name street_address donation_date \$state preupdate_full_name preupdate_street_address preupdate_donation_date',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('view_appaserver_error_file','view_appaserver_error_file.sh \$application /var/log/appaserver line_count','Most error messages are logged to this file. If you get the Server Error screen, then this file is the first place to find a clue. <big><bold>Warning:</bold></big> this process exposes the session number assigned to each user''s login.',null,null,null,'output',null,'y');
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('build_website','build_capitolpops \$application \$process',null,null,null,null,'manipulate',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('membership_status_list','membership_status_list.sh \$application \$process output_medium',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('reset_membership_status','reset_membership_status.sh \$application \$process execute_yn','This process resets the membership status for each active member to ''Not Paid''. It omits the students.',null,null,null,'manipulate',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('membership_position_list','membership_position_list.sh \$application \$process output_medium',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('send_patron_mail','send_patron_mail.sh \$application email_address date time',null,null,null,null,'manipulate',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_concert','populate_concert.sh \$application',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('merge_purge','merge_purge \$application \$session \$role \$process',null,null,null,null,'manipulate',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('composition_venue_count','composition_venue_count_output \$application \$session \$process composition city venue output_medium',null,null,null,null,'output',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_composition','populate_composition.sh \$application \$one2m_folder \$state',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_music_folder','populate_music_folder.sh \$application \$one2m_folder \$state',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_inventory','populate_inventory.sh \$application \$one2m_folder',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_specific_inventory_purchase','populate_specific_inventory_purchase.sh \$application \$one2m_folder',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_customer_payment','post_change_customer_payment \$application full_name street_address sale_date_time payment_date_time \$state preupdate_payment_date_time',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_customer_sale','post_change_customer_sale \$application full_name street_address sale_date_time \$state preupdate_full_name preupdate_street_address preupdate_title_passage_rule preupdate_completed_date_time preupdate_shipped_date_time preupdate_arrived_date preupdate_shipping_revenue',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_fixed_asset_purchase','post_change_fixed_asset_purchase \$application full_name street_address purchase_date_time asset_name serial_number \$state preupdate_asset_name preupdate_serial_number preupdate_extension preupdate_declining_balance_n preupdate_depreciation_method',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_inventory_purchase','post_change_inventory_purchase \$application full_name street_address purchase_date_time inventory_name \$state preupdate_ordered_quantity preupdate_arrived_quantity preupdate_missing_quantity preupdate_unit_cost preupdate_inventory_name',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_inventory_sale','post_change_inventory_sale \$application full_name street_address sale_date_time inventory_name \$state preupdate_quantity preupdate_retail_price preupdate_discount_amount preupdate_inventory_name',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_purchase_order','post_change_purchase_order \$application full_name street_address purchase_date_time \$state preupdate_full_name preupdate_street_address preupdate_title_passage_rule preupdate_shipped_date preupdate_arrived_date_time',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_service_purchase','post_change_service_purchase \$application full_name street_address purchase_date_time account \$state preupdate_account',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_service_sale','post_change_service_sale \$application full_name street_address sale_date_time service_name \$state',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_specific_inventory_purchase','post_change_specific_inventory_purchase \$application full_name street_address purchase_date_time inventory_name serial_number \$state',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_specific_inventory_sale','post_change_specific_inventory_sale \$application full_name street_address sale_date_time inventory_name serial_number \$state',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('insert_program_from_rehearsal_lineup','insert_program_from_rehearsal_lineup.sh \$application \$process concert_title date',null,null,null,null,'manipulate',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_payment','post_change_payment.sh \$application full_name street_address sale_date_time',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('load_bank_spreadsheet','load_bank_spreadsheet \$application \$process fund filename execute_yn','<h3>Expected format:</h3> <table border><th>Date<th>Description<th>Bank Amount<th>Running Balance</table><br>',null,null,null,'load',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('financial_position','financial_position \$application \$process fund as_of_date subclassification_option output_medium',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('generate_invoice','generate_invoice \$application \$process full_name street_address sale_date_time',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('generate_workorder','generate_workorder \$application \$process full_name street_address sale_date_time',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('select_open_customer_sale','select_customer_sale.sh \$application \$state open',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('statement_of_activities','statement_of_activities \$application \$process fund as_of_date subclassification_option output_medium net_income_only_yn',null,null,null,null,'output',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_dues_payment','post_change_dues_payment \$application full_name street_address payment_date \$state preupdate_full_name preupdate_street_address preupdate_payment_date preupdate_payment_amount',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_reoccurring_transaction_recent','post_reoccurring_transaction \$application \$process full_name street_address transaction_date transaction_amount memo execute_yn',null,null,null,null,'manipulate',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('program_profit','program_profit \$application \$process program begin_date end_date aggregate_account_yn output_medium',null,null,null,null,'output',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('depreciate_fixed_assets','depreciate_fixed_assets \$application \$process fund undo_yn execute_yn',null,null,null,null,'manipulate',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_prepaid_asset_purchase','post_change_prepaid_asset_purchase \$application full_name street_address purchase_date_time asset_name \$state preupdate_asset_name preupdate_extension preupdate_accrual_period_years',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('post_change_prepaid_asset_accrual','post_change_prepaid_asset_accrual \$application full_name street_address purchase_date_time asset_name accrual_date \$state preupdate_full_name preupdate_street_address preupdate_purchase_date_time preupdate_asset_name preupdate_accrual_date',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('donor_list','donor_list.sh \$application \$process year aggregate output_medium',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('print_checks','print_checks_process \$application \$process \$session fund full_name street_address starting_check_number memo check_amount with_stub_yn execute_yn',null,null,null,null,'manipulate',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_print_checks_entity','populate_print_checks_entity.sh \$application fund',null,null,null,null,'output',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_subclassification','populate_subclassification.sh \$application \$where \$state',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('inventory_balance_detail','inventory_balance_detail \$application \$process inventory_name output_medium',null,null,null,null,'output',null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('create_application','application','null','null','destination_application','1',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('table_rectification','application','null','null','null','1',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('export_folder','application','null','null','destination_application','1',null,null,null,null);
...
insert into role_process (process,role) values ('build_website','accountant');
...
insert into role_process (process,role) values ('appaserver_info','librarian');
insert into role_process (process,role) values ('build_website','librarian');
insert into role_process (process,role) values ('change_password','librarian');
insert into role_process (process,role) values ('composition_venue_count','librarian');
insert into role_process (process,role) values ('execute_select_statement','librarian');
insert into role_process (process,role) values ('insert_program_from_rehearsal_lineup','librarian');
insert into role_process (process,role) values ('membership_position_list','librarian');
insert into role_process (process,role) values ('membership_status_list','librarian');
insert into role_process (process,role) values ('merge_purge','librarian');
insert into role_process (process,role) values ('view_documentation','librarian');
insert into role_process (process,role) values ('view_source','librarian');
insert into role_process (process,role) values ('appaserver_info','supervisor');
insert into role_process (process,role) values ('build_website','supervisor');
