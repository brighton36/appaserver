...
insert into transaction ( full_name, street_address, transaction_date_time, transaction_amount, memo ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:24:41', '$cash_opening_balance', 'Opening entry' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, debit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:24:41', '$cash_account_name', '$cash_opening_balance' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, credit_amount ) values ( 'changeme', '1234 Main St.', '2019-04-18 12:24:41', '$equity_account_name', '$cash_opening_balance' );
...
insert into bank_upload_transaction ( bank_date, bank_description, full_name, street_address, transaction_date_time ) values ( '2019-04-18', 'Opening balance', 'changeme', '1234 Main St.', '2019-04-18 12:24:41' );
all_done13
) | sql.e 2>&1 | grep -vi duplicate
...
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Mobil1 Oil Filter','inventory','cost_of_goods_sold','standard','16.99','20','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Plain oil','inventory','cost_of_goods_sold','standard','10.00','50','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W20','inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
insert into inventory (inventory_name,credit_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W30','inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
all_done8
) | sql.e 2>&1 | grep -vi duplicate
