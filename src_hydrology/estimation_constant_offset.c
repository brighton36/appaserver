...
int main( int argc, char **argv )
{
	...
	{
		fprintf(stderr,
"Usage: %s person application station datatype offset multiplier multiply_first_then_add_yn begin_date begin_time end_date end_time parameter_dictionary \"where_clause\" notes really_yn\n",
			argv[ 0 ] );
		exit( 1 );
	}
