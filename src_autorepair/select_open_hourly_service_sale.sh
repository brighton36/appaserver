...
select="hourly_service_sale.full_name, hourly_service_sale.street_address, hourly_service_sale.sale_date_time, service_name, concat( description, ' [', vehicle_make, ',', vehicle_model, ',', vehicle_trim, ',', vehicle_year, ' EstHrs=', estimated_hours, ']' )"
