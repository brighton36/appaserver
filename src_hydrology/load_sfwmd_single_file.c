/* ---------------------------------------------------	*/
/* src_hydrology/load_sfwmd_single_file.c		*/
/* ---------------------------------------------------	*/
...
int load_sfwmd_filespecification(
		...
		if ( really_yn == 'y' )
		{
			...
			else
			{
				...
				if ( update_pipe )
				{
		 			fprintf(
				 	update_pipe,
				 	"%s^%s^%s^null^measurement_value^%lf\n",
				 	sfwmd_station_datatype->station,
				 	sfwmd_station_datatype->datatype,
				 	sfwmd_station_datatype->
						measurement_date_string,
			...
			&&   *sfwmd_station_datatype->db_key )
			{
				...
				{
		 			fprintf( update_pipe,
				 "%s^%s^%s^null^last_validation_process^%s\n",
				 	sfwmd_station_datatype->station,
				 	sfwmd_station_datatype->datatype,
				 	sfwmd_station_datatype->
						measurement_date_string,
				...
				last_validation_date_string )
			{
				...
				{
		 			fprintf( update_pipe,
				 "%s^%s^%s^null^last_validation_date^%s\n",
				 	sfwmd_station_datatype->station,
				 	sfwmd_station_datatype->datatype,
				 	sfwmd_station_datatype->
						measurement_date_string,
			...
			{
		 		fprintf( update_pipe,
				 "%s^%s^%s^null^measurement_update_method^%s\n",
				 	sfwmd_station_datatype->station,
				 	sfwmd_station_datatype->datatype,
				 	sfwmd_station_datatype->
						measurement_date_string,
