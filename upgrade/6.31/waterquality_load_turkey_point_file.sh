...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,appaserver_yn,process_group,process_set_display,preprompt_help_text) values ('load_turkey_point_file','load_turkey_point_file \$application \$process project_name filename execute_yn',null,null,null,null,'load',null,null);
insert into $role_process (role,process) values ('scientist','load_turkey_point_file');
insert into $role_process (role,process) values ('supervisor','load_turkey_point_file');
...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('load_turkey_point_file','water_project','null','null','null','1',null,null,null,null);
