/* ---------------------------------------------------------------	*/
/* src_accountancymodel/post_change_service_sale.c			*/
/* ---------------------------------------------------------------	*/
/* 									*/
...
/* Prototypes */
/* ---------- */
void post_change_service_sale_delete(
				char *application_name,
				char *full_name,
				char *street_address,
				char *sale_date_time );

void post_change_service_sale_insert(
				char *application_name,
				char *full_name,
				char *street_address,
				char *sale_date_time,
...
void post_change_service_sale_update(
				char *application_name,
				char *full_name,
				char *street_address,
				char *sale_date_time,
...
"Usage: %s application full_name street_address sale_date_time service_name state\n",
	...
	{
		post_change_service_sale_delete(
			application_name,
			full_name,
			street_address,
			sale_date_time );
	...
	{
		post_change_service_sale_insert(
			application_name,
			full_name,
			street_address,
			sale_date_time,
	...
	{
		post_change_service_sale_update(
			application_name,
			full_name,
			street_address,
			sale_date_time,
