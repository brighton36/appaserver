/* --------------------------------------------------------------------- */
/* $APPASERVER_HOME/src_predictive/tax_recover_prior_fixed_assets.c 	 */
/* --------------------------------------------------------------------- */
/* 									 */
...
/* Prototypes */
/* ---------- */
void tax_recover_prior_fixed_assets_process_display(
					char *application_name,
					char *process_name,
					boolean undo );

void tax_recover_prior_fixed_assets_process_execute(
					char *application_name,
					char *fund_name,
					char *process_name,
					boolean undo );

void tax_recover_prior_fixed_assets_undo(char *application_name,
					char *fund_name,
					char *depreciation_date );

boolean tax_recover_prior_fixed_assets_execute(
					char *application_name,
					char *fund_name,
					char *prior_depreciation_date,
					char *depreciation_date );

boolean tax_recover_prior_fixed_assets_display(
					char *application_name,
					char *prior_depreciation_date,
					char *depreciation_date,
					char *process_name );
...
int main( int argc, char **argv )
{
	...
	if ( execute )
	{
		tax_recover_prior_fixed_assets_process_execute(
			application_name,
			fund_name,
			process_name,
			undo );
	...
	{
		tax_recover_prior_fixed_assets_process_display(
			application_name,
			process_name,
			undo );
	}
					...
					boolean undo )
{
	...
	if ( undo )
	{
		...
		tax_recover_prior_fixed_assets_undo(
			application_name,
			fund_name,
			depreciation_date );
					...
					boolean undo )
{
	...
	if ( !tax_recover_prior_fixed_assets_display(
		application_name,
		prior_depreciation_date,
		depreciation_date,
		process_name ) )
					...
					char *depreciation_date )
{
	...
	DEPRECIATE_PRIOR_FIXED_ASSET_DEPRECIATION *
		tax_recover_prior_fixed_asset_depreciation;
	...
	tax_recover_prior_fixed_asset_depreciation =
		tax_recover_prior_fixed_asset_depreciation_new(
			application_name,
	...
	if ( !list_length( 
		tax_recover_prior_fixed_asset_depreciation->
			tax_recover_prior_fixed_asset_list ) )
	{
		return 0;
	}
...
} /* tax_recover_prior_fixed_assets_execute() */
...
} /* tax_recover_prior_fixed_assets_display() */
