...
echo "alter table $table_name add omit_lookup_before_drop_down_yn char (1);" | sql.e
...
echo "insert into $folder_attribute_table				\
	...
	values								\
	('relation','omit_lookup_before_drop_down_yn',0,8,'n','n');"	 				 |
sql.e
...
echo "insert into $attribute_table					\
	...
	values								\
	('omit_lookup_before_drop_down_yn','text',1,0,'','y');"					 |
sql.e
