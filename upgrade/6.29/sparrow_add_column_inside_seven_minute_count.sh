...
echo "alter table $table_name add inside_seven_minute_count integer;" | sql.e
...
echo "insert into $folder_attribute_table				\
	...
	values								\
	('site_visit','inside_seven_minute_count',0,10,'n','n');"	 				 |
sql.e
...
echo "insert into $attribute_table					\
	...
	values								\
	('inside_seven_minute_count','integer',2,0,'','n');"					 |
sql.e
