...
/*
		sprintf(output_filename, 
		 	OUTPUT_SPECIES_DETAIL_TEMPLATE,
		 	appaserver_mount_point,
		 	application_name, 
		 	begin_date_string,
		 	end_date_string,
...
/*
					...
					application_name ) == 'y' )
		{
			sprintf(ftp_detail_filename, 
		 		FTP_SPECIES_PREPEND_DETAIL_TEMPLATE, 
				application_get_http_prefix( application_name ),
		 		appaserver_library_get_server_address(),
		 		application_name,
				begin_date_string,
		...
		{
			sprintf(ftp_detail_filename, 
		 		FTP_SPECIES_NONPREPEND_DETAIL_TEMPLATE, 
		 		application_name,
				begin_date_string,
				end_date_string,
		 		process_id );
...
/*
	sprintf( output_filename, 
		 OUTPUT_SPECIES_PER_AREA_TEMPLATE,
		 appaserver_mount_point,
		 application_name,
		 begin_date_string,
		 end_date_string,
...
/*
	...
	{
		sprintf(ftp_summary_filename, 
		 	FTP_SPECIES_PREPEND_PER_AREA_TEMPLATE, 
			application_get_http_prefix( application_name ),
		 	appaserver_library_get_server_address(),
		 	application_name,
			begin_date_string,
	...
	{
		sprintf(ftp_summary_filename, 
		 	FTP_SPECIES_NONPREPEND_PER_AREA_TEMPLATE, 
		 	application_name,
			begin_date_string,
			end_date_string,
		 	process_id );
...
/*
	sprintf( output_filename, 
		 OUTPUT_CPUE_PER_SPECIES_TEMPLATE,
		 appaserver_mount_point,
		 application_name,
		 begin_date_string,
		 end_date_string,
