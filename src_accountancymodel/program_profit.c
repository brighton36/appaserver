...
/*
#define FTP_OUTPUT_FILE_TEMPLATE	"http://%s/%s/%s_%d.%s"
#define LATEX_FILE_TEMPLATE		"%s_%d.tex"
#define LATEX_DVI_FILE_TEMPLATE		"%s_%d.dvi"
*/
...
int main( int argc, char **argv )
{
	...
	{
		fprintf( stderr,
"Usage: %s application process program begin_date end_date output_medium\n",
			 argv[ 0 ] );
		exit ( 1 );
	}
