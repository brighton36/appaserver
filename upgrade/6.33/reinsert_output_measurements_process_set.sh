...
insert into $process_set_parameter (process_set,folder,prompt,attribute,drop_down_prompt,display_order,preprompt_yn,drop_down_multi_select_yn,populate_drop_down_process,populate_helper_process) values ('output_measurements','datatype','null','null','null','1','y','y',null,null);
insert into $process_set_parameter (process_set,folder,prompt,attribute,drop_down_prompt,display_order,preprompt_yn,drop_down_multi_select_yn,populate_drop_down_process,populate_helper_process) values ('output_measurements','favorite_station_set','null','null','null','3','y',null,null,null);
...
insert into $process_set_parameter (process_set,folder,prompt,attribute,drop_down_prompt,display_order,preprompt_yn,drop_down_multi_select_yn,populate_drop_down_process,populate_helper_process) values ('output_measurements','station','null','null','null','2','y','y',null,'station_map');
