...
then
	...
	echo "		cp organism_report.sh species_report.sh"
	echo "		cp organism_report.sql species_report.sql"
	echo "		cp organism_report.lst species_report.lst"
	echo
	) 1>&2
	exit 1
fi
