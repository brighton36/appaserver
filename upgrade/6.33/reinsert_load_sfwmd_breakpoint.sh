...
insert into $process (process,command_line,notepad,html_help_file_anchor,process_set_display,appaserver_yn,process_group,preprompt_help_text,post_change_javascript) values ('load_SFWMD_breakpoint_data','load_sfwmd_breakpoint_data \$process filename execute_yn',null,null,null,null,'load',null,null);
