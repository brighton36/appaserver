		...
		LIST *customer_sale_list )
{
	...
	do {
		...
		/* If deleted the service revenue. */
		/* ------------------------------- */
		if ( !customer_sale->sum_service_extension
		&&   credit_amount )
		{
			customer_sale_ledger_refresh(
				application_name,
		...
		/* ------------------------------- */
		/* If changed the service revenue. */
		/* ------------------------------- */
		if ( !dollar_virtually_same(
			credit_amount,
			customer_sale->sum_service_extension ) )
		{
			/* Update service_revenue */
			/* ---------------------- */
			ledger_journal_ledger_update(
				update_pipe,
				customer_sale->
		...
		/* If deleted the sales tax payable. */
		/* --------------------------------- */
		...
		/* --------------------------------- */
		/* If changed the sales tax payable. */
		/* --------------------------------- */
		if ( !dollar_virtually_same(
			credit_amount,
			customer_sale->sales_tax ) )
		{
			/* Update sales_tax_payable */
			/* ------------------------ */
			ledger_journal_ledger_update(
				update_pipe,
				customer_sale->
		...
		/* If deleted the shipping revenue. */
		/* -------------------------------- */
		if ( !customer_sale->shipping_revenue
		&&   credit_amount )
		{
			customer_sale_ledger_refresh(
				application_name,
		...
		/* -------------------------------- */
		/* If changed the shipping revenue. */
		/* -------------------------------- */
		if ( !dollar_virtually_same(
			credit_amount,
			customer_sale->shipping_revenue ) )
		{
			/* Update shipping_revenue */
			/* ----------------------- */
			ledger_journal_ledger_update(
				update_pipe,
				customer_sale->
		...
		/* ---------------------------------- */
		/* If changed the account receivable. */
		/* ---------------------------------- */
		if ( !dollar_virtually_same(
			debit_amount,
			customer_sale->invoice_amount ) )
